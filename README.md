# mirandas-cv2-p5-numpy-mediapipe-face-movement-obby
This is an interactive game that allows you to play an obby with your face movements and webcam. Open your mouth to jump, turn your head(yaw) left to right to move. 这是一款互动游戏，你可以通过面部表情来玩障碍赛。张开嘴巴跳跃，左右转头（偏航）移动。 
...
# MediaPipe landmarks, this will mark areas of your face
